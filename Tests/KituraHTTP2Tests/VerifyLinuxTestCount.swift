 ...
 **/
    ...
    class VerifyLinuxTestCount: XCTestCase {
        func testVerifyLinuxTestCount() {
            ...
            // UtilsTests
            linuxCount = UtilsTests.allTests.count
            darwinCount = Int(UtilsTests.defaultTestSuite().testCaseCount)
            XCTAssertEqual(linuxCount, darwinCount, "\(darwinCount - linuxCount) tests are missing from UtilsTests.allTests")
        }
    }
#endif
